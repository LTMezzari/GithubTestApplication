package mezzari.torres.lucas.github_test_application.persistence.preferences
...
object PreferencesManager: IPreferencesManager {
    ...
    fun initialize(context: Context) {
        sharedPreferences = context.getSharedPreferences("GITHUB_TEST_APPLICATION", Context.MODE_PRIVATE)
    }

    override var user: User? set(value) {
        sharedPreferences.takeIf { ::sharedPreferences.isInitialized }?.also {
            val editor = it.edit()
